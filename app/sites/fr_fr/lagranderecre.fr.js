...
exports.fetch = function (casper, timeout, callback) {
    ...
    casper.waitUntilVisible("body", function () {
        try {
            if (casper.exists("div.notfound404")) {
                json.stock = "notfound";
                json.status = true;
                callback(json);
            } else {
                //var oos = this.fetchText("button.outOfStockButton");
                //if (!oos || oos.indexOf("non disponible en stock") === -1) {
...
//							casper.capture("2.png");
                                this.sendKeys('input#tags', '77110', {keepFocus: true});
                                casper.wait(3000, function () {
//								casper.capture("3.png");
                                    this.then(function () {
                                        if (this.exists("ul.ui-autocomplete > li.ui-menu-item > a")) {
                                            this.mouse.doubleclick("ul.ui-autocomplete > li.ui-menu-item:nth-child(10) > a");
